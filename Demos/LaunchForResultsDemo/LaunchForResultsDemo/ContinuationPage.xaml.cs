...
namespace LaunchForResultsDemo
{
  ...
  public sealed partial class ContinuationPage : Page
  {
    ...
    protected override void OnNavigatedTo(NavigationEventArgs e)
    {
      ...
      {
        // Need to override Back Button handling so that this app navigates back to 
        // an appropriate page to continue the user experience.
        // If you dont do this, Back will take the user back to the previous app (****IS THIS TRUE???****)
